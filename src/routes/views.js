...
class ViewRouter extends Router {
    init() {
        ...
        // Ruta para login
        this.get('/login', userIsNotLoggedId, (_, res) => {
            res.render('login', {
                title: 'Login',
            })
        });
        ...
        // Ruta para login
        this.get('/resetPassword', userIsNotLoggedId, (_, res) => {
        ...
        // Ruta para register
        this.get('/register', userIsNotLoggedId, (_, res) => {
            res.render('register', {
                title: 'Register',
            })
        });
        ...
        // Ruta para profile
        this.get('/profile', userIsLoggedIn, async (req, res) => {
        ...
        this.get('/products/:pid', userIsLoggedIn, async (req, res) => {
            try{
