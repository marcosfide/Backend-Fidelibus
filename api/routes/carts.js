...
class CartsRouter extends Router {
    init() {
        ...
        this.post('/', userIsNotAdmin, withController((controller, req, res) => controller.addCart(req, res)));

        // Ruta para agregar el producto al arreglo products del carrito seleccionado por id
        this.post('/:cid/product/:pid', userIsNotAdmin, withController((controller, req, res) => controller.addProductToCart(req, res)));

        // Ruta para agregar el producto al arreglo products del carrito seleccionado por id
        this.post('/product/:pid', userIsNotAdmin, withController((controller, req, res) => controller.addProductToCartView(req, res)));

        // Ruta para eliminar un producto por id correspondiente al carrito seleccionado por id
        this.delete('/:cid/products/:pid', userIsNotAdmin, withController((controller, req, res) => controller.deleteProductFromCart(req, res)));

        // Ruta para eliminar un producto por id correspondiente al carrito seleccionado por id
        this.delete('/product/:pid', userIsNotAdmin, withController((controller, req, res) => controller.deleteProductFromCartView(req, res)));
